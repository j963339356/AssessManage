define(['/hzml/common/js/config.js'], function () {
    require(['jquery', 'common', 'helper', 'layui','customtable','nav'], function ($) {
        ...
        $("#query").click(function () {
            ...
            Helper.Ajax("Analysis/kcgjhqk", body, function (result) {
        ...
        CustomTable.init({
            elem: "#table1",
            url: '/hzml/api/Analysis/kcgjhqk', //数据接口
            ...
            cols: [[ //标题栏
                ...
                ,{field: 'pScore', title: 'P3分值'}
                ,{field: 'rate', title: '城乡道路客运车辆公交化比率'}
                ,{field: 'name1', title: '城乡道路客运车辆数'}
                ,{field: 'name2', title: '其中：城市公交车辆数'}
                ,{field: 'name3', title: '其中：公交化运营的农村客运车辆数'}
            ]]
        });
    })
})
