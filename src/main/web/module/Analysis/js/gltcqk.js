define(['/hzml/common/js/config.js'], function () {
    require(['jquery', 'common', 'helper', 'layui','customtable','nav'], function ($) {
        ...
        $("#query").click(function () {
            ...
            Helper.Ajax("Analysis/gltcqk", body, function (result) {
        ...
        CustomTable.init({
            elem: "#table1",
            url: '/hzml/api/Analysis/gltcqk', //数据接口
            ...
            cols: [[ //标题栏
                ...
                ,{field: 'pScore', title: 'P1分值'}
                ,{field: 'rate', title: '行政村公路通畅率'}
                ,{field: 'name1', title: '行政村总数'}
                ,{field: 'name2', title: '已通路行政村数量'}
            ]]
        });
    })
})
