define(['/hzml/common/js/config.js'], function () {
    require(['jquery', 'common', 'helper', 'layui','customtable','nav'], function ($) {
        ...
        $("#query").click(function () {
            ...
            Helper.Ajax("Analysis/kctcqk", body, function (result) {
        ...
        CustomTable.init({
            elem: "#table1",
            url: '/hzml/api/Analysis/kctcqk', //数据接口
            ...
            cols: [[ //标题栏
                ...
                ,{field: 'pScore', title: 'P2分值'}
                ,{field: 'rate', title: '行政村通客车率'}
                ,{field: 'name1', title: '行政村总数'}
                ,{field: 'name2', title: '通客运车辆行政村数'}
            ]]
        });
    })
})
